...
namespace redBus_api.Migrations
{
    ...
    [Migration("20250916042936_Added_Ref_to_Vendor_&_VendorProfilePic_and")]
    partial class Added_Ref_to_Vendor__VendorProfilePic_and
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("redBus_api.Model.BusBookingPassenger", b =>
                {
                    ...
                    b.Property<int?>("RefundableAmount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("redBus_api.Model.VendorBankDetails", b =>
                {
                    b.Property<int>("VendorBankDetailsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("VendorBankDetailsId"));
                    ...
                    b.HasKey("VendorBankDetailsId");

                    b.HasIndex("VendorId")
                        .IsUnique();

                    b.ToTable("VendorBankDetails", (string)null);
                });

            modelBuilder.Entity("redBus_api.Model.VendorProfilePic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("VendorProfilePic", (string)null);
                });

            modelBuilder.Entity("redBus_api.Model.BusBooking", b =>
                {
                    b.HasOne("redBus_api.Model.BusSchedule", "BusSchedule")
                        .WithMany()
            ...
            modelBuilder.Entity("redBus_api.Model.VendorBankDetails", b =>
                {
                    b.HasOne("redBus_api.Model.Vendor", "Vendor")
                        .WithOne("VendorBankDetails")
                        .HasForeignKey("redBus_api.Model.VendorBankDetails", "VendorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("redBus_api.Model.VendorProfilePic", b =>
                {
                    b.HasOne("redBus_api.Model.Vendor", "Vendor")
                        .WithOne("VendorProfilePic")
                        .HasForeignKey("redBus_api.Model.VendorProfilePic", "VendorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("redBus_api.Model.Vendor", b =>
                {
                    b.Navigation("VendorBankDetails");

                    b.Navigation("VendorProfilePic");
                });
